...
interface TasksPanelProps {
  ...
  taskFilterDateScope: 'today' | 'seven-days' | 'all';
  ...
  setTaskFilterDateScope: (value: 'today' | 'seven-days' | 'all') => void;
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="space-y-0.5">
                ...
                <select
                  ...
                  onChange={(event) => setTaskFilterDateScope(event.target.value as 'today' | 'seven-days' | 'all')}
                  className="px-2.5 py-1.5 text-xs border border-slate-200 bg-white rounded-lg text-slate-700 font-semibold outline-none transition-colors hover:border-slate-300"
                >
